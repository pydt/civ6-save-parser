...
describe('Modify civtype2 save', function() {
  ...
  it('should be able to add MPH mod', () => {
    ...
    expect(data.parsed.MOD_BLOCK_2_2.data.length).to.equal(modifiedData.parsed.MOD_BLOCK_2_2.data.length - 1);
    expect(data.parsed.MOD_BLOCK_3.data.length).to.equal(modifiedData.parsed.MOD_BLOCK_3.data.length - 1);
    expect(data.parsed.MOD_BLOCK_3_2.data.length).to.equal(modifiedData.parsed.MOD_BLOCK_3_2.data.length - 1);
